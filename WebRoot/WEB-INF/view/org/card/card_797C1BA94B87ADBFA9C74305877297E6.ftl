	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td class="musthaveinfo"><input class="card_datedit" type="text" name="" disabled value="${cardDetailInfo["GOUZRQ"]}"></td>
				<td class="text-idt">投入使用日期</td>
				<td><input class="card_datedit" type="text" name="" disabled value="${cardDetailInfo["TOURSYRQ"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="text-idt">预计使用年限</td>
				<td><input type="text" name="" disabled value="${cardDetailInfo["YUJSMZL"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">开发商</td>
