	...
	<div class="detail_card_info">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="shengccj" disabled value="${cardDetailInfo["SHENGCCJ"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="mustnumber"><input type="text" name="yujsmzl" disabled value="0" value="${cardDetailInfo["YUJSMZL"]}"></td>
				<td class="text-idt">定期保养期限（月）</td>
				<td class="mustnumber"><input type="text" name="baoyqx" disabled value="0" value="${cardDetailInfo["BAOYQX"]}"></td>
			</tr>
			<tr>
