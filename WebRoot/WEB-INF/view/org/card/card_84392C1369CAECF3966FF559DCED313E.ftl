...
<div class="card_info_main">
	<div class="detail_card_info">
		<table>
			<tr>
				<td class="text-idt">纲属科</td>
				<td><input type="text" name="gangsk" disabled value="${cardDetailInfo["GANGSK"]}"></td>
				<td class="text-idt">产地</td>
			...
			<tr>
				...
				<td class="text-idt"><span>*</span>出生/栽种年龄</td>
				<td class="musthaveinfo mustnumber"><input type="text" name="chuszznf" disabled value="${cardDetailInfo["CHUSZZNF"]}"></td>
			</tr>
			<tr>
				...
				<td class="text-idt">寿命/种龄</td>
				<td><input type="text" name="yujsmzl" disabled value="${cardDetailInfo["YUJSMZL"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">销售商</td>
				<td><input type="text" name="jingxs" disabled value="${cardDetailInfo["JINGXS"]}"></td>
				<td class="text-idt">销售商电话</td>
	...
	<div class="detail_card_info">
		<table>
			...
			<tr>
				...
				<td class="mustnumber musthaveinfo"><input type="text" name="danj" disabled value="${cardDetailInfo["DANJ"]}"></td>
			</tr>
			<tr>
