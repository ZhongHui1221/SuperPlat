...
<div class="card_info_main">
	<div class="detail_card_info">
		<table>
			<tr>
				<td class="text-idt"><span>*</span>著作权人</td>
				<td class="musthaveinfo"><input type="text" name="famr" disabled value="${cardDetailInfo["FAMR"]}"></td>
				<td class="text-idt"><span>*</span>出版日期</td>
				<td class="musthaveinfo"><input class="card_datedit" type="text" name="chubrq" disabled value="${cardDetailInfo["CHUBRQ"]}"></td>
			...
			<tr>
				...
				<td><input type="text" name="zhengsh" disabled value="${cardDetailInfo["ZHENGSH"]}"></td>
