...
<div class="card_info_main">
	<div class="detail_card_info">
		<table>
			<tr>
				<td class="text-idt">授权证明</td>
				<td colspan="3" class="colspan_width"><input type="text" name="fammc" disabled value="${cardDetailInfo["FAMMC"]}"></td>
			...
			<tr>
				...
				<td colspan="3" class="colspan_width"><input type="text" name="zhengsh" disabled value="${cardDetailInfo["ZHENGSH"]}"></td>
	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td><input type="text" name="shouynx" disabled value="${cardDetailInfo["FAPH"]}"></td>
			</tr>
			<tr>
