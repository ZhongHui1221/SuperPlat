	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td colspan="3" class="colspan_width"><input type="text" name="dangah" disabled value="${cardDetailInfo["DANGAH"]}"></td>
				<td class="text-idt">保存年限</td>
				<td><input type="text" name="baocnx" disabled value="${cardDetailInfo["BAOCNX"]}"></td>
			</tr>
			<tr>
				...
				<td class="musthaveinfo"><input type="text" name="gouzrq" disabled value="${cardDetailInfo["GOUZRQ"]}"></td>
				<td class="text-idt">投入使用日期</td>
				<td><input type="text" name="toursyrq" disabled value="${cardDetailInfo["TOURSYRQ"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="chubs" disabled value="${cardDetailInfo["CHUBS"]}"></td>
				<td></td>
				<td></td>
				<td class="text-idt">出版日期</td>
				<td><input type="text" name="chubrq" disabled value="${cardDetailInfo["CHUBRQ"]}"></td>
			</tr>
			<tr>
	...
	<div class="detail_card_info" style="border-bottom: none">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="kaixrq" disabled value="${cardDetailInfo["KAIXRQ"]}"></td>
			</tr>
			<tr>
