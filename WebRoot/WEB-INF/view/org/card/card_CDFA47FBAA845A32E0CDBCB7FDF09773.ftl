	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td class="musthaveinfo"><input type="text" name="fammc" disabled value="${cardDetailInfo["FAMMC"]}"></td>
			...
			<tr>
				...
				<td class="musthaveinfo"><input type="text" name="zhuanlh" disabled value="${cardDetailInfo["ZHUANLH"]}"></td>
				<td class="text-idt"><span>*</span>授权公告日</td>
				<td class="musthaveinfo"><input class="card_datedit" type="text" name="shouqggz" disabled value="${cardDetailInfo["SHOUQGGZ"]}"></td>
