	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td class="colspan_width musthaveinfo" colspan="3"><input type="text" name="zuolwz" disabled value="${cardDetailInfo["ZUOLWZ"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="text-idt">竣工日期</td>
				<td><input class="card_datedit" type="text" name="jungrq" disabled value="${cardDetailInfo["JUNGRQ"]}"></td>
			...
			<tr>
				...
				<td class="text-idt">设计用途</td>
				<td><input type="text" name="shejyt" disabled value="${cardDetailInfo["SHEJYT"]}"></td>
				<td class="text-idt">发证日期</td>
				<td><input class="card_datedit" type="text" name="" disabled value="${cardDetailInfo["LICENCEDATE"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">预计使用年限（月）</td>
				<td class="mustnumber"><input type="text" name="yujsmzl" disabled value="${cardDetailInfo["YUJSMZL"]}"></td>
				<td class="text-idt">房屋所有权人</td>
				<td><input type="text" name="tudsyqr" disabled value="${cardDetailInfo["TUDSYQR"]}"></td>
				<td class="text-idt">建筑结构</td>
				<td>
					<select name="jianzjgid" disabled>
	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td class="mustnumber"><input type="text" name="xingzbgmj" disabled value="${cardDetailInfo["XINGZBGMJ"]}"></td>
				<td class="text-idt">业务用房面积(m²)</td>
				<td class="mustnumber"><input type="text" name="yewyfmj" disabled value="${cardDetailInfo["YEWYFMJ"]}"></td>
			</tr>
			<tr>
