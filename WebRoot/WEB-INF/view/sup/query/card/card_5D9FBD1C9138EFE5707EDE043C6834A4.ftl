	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td colspan="3" class="colspan_width"><input type="text" name="ZUOLWZ" disabled="true" value="${cardDetailInfo["ZUOLWZ"]}"></td>
			...
			<tr>
				...
				<td><input type="text" name="TOURSYRQ" disabled="true" value="${cardDetailInfo["TOURSYRQ"]}"></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="QUANSZM" disabled="true" value="${cardDetailInfo["QUANSZM"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="text-idt"><span>*</span>使用权类型</td>
				<td>
					<select disabled="true">
	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td class="text-idt"><span>*</span>其中：独用面积(m²)</td>
				<td><input type="text" name="" disabled="true" value="${((cardDetailInfo["DUYMJ"]?string("0.00"))!"0.00")}"></td>
				<td class="text-idt">分摊面积（m²）</td>
				<td><input type="text" name="" disabled="true" value="${((cardDetailInfo["FENTMJ"]?string("0.00"))!"0.00")}"></td>
			</tr>
			<tr>
