	...
	<div class="detail_card_info">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["CHELCD"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">供应商</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["JINGXS"]}"></td>
			...
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["SHIYXZ"]}"></td>
				<td class="text-idt">车辆识别号</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["CHELSBH"]}"></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["CHEPH"]}"></td>
				<td class="text-idt"><span>*</span>排气量（升）</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["PAIQL"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">发动机号</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["FADJH"]}"></td>
				<td></td>
				<td></td>
				<td class="text-idt"><span>*</span>行驶证注册日期</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["CHELXSZZCRQ"]}"></td>
			</tr>
			<tr>
