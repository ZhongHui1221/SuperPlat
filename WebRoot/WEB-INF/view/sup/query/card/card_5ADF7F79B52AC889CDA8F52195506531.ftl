	...
	<div class="detail_card_info">
		<table>
			...
			<tr>
				...
				<td colspan="3" class="colspan_width"><input type="text" name="" disabled="true" value="${cardDetailInfo["ZHUANLH"]}"></td>
		...
		<table>
			...
			<tr>
				...
				<td rowspan="2" colspan="3">
					<textarea disabled="true">${cardDetailInfo["FAMR"]}</textarea>
				</td>
			</tr>
		</table>
		<table>
