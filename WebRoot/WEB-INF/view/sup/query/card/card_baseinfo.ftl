	...
	<div class="detail_card_info">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="0" value="${cardDetailInfo["YUJSMZL"]}"></td>
				<td class="text-idt">定期保养期限（月）</td>
				<td><input type="text" name="" disabled="true" value="0" value="${cardDetailInfo["BAOYQX"]}"></td>
			</tr>
			<tr>
	...
	<div class="detail_card_info">
		<table>
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["JIAZ"]}"></td>
				<td class="text-idt">发票号</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["FAPH"]}"></td>
			</tr>
			<tr>
				<td class="text-idt">财政补助收入</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["CAIZBTSR"]}"></td>
				<td class="text-idt">科教项目收入</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["KEJXMSR"]}"></td>
				<td class="text-idt">其他</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["QITSR"]}"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["LEIJZJ"]}"></td>
				<td class="text-idt">账面净值</td>
				<td><input type="text" name="" disabled="true" value="${cardDetailInfo["JINGZ"]}"></td>
			</tr>
		</table>
	</div>
	<div class="detail_card_info" style="border-bottom: none">
		...
		<table>
			<tr>
				...
				<td><input type="text" name="" disabled="true" value=""></td>
