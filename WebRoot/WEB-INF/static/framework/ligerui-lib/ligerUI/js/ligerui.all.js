...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        toggleSwitch: function (btn)
        {
            ...
            //修改
            var li_length = $(".l-tab-links ul li").length;
            if( li_length > 2 && li_length <=3){
                $("<a href='javascript:void(0)' class='close_all'>关闭全部</a>").appendTo(windowsswitch);
            }else if(li_length > 3){
                $("<a href='javascript:void(0)' class='close_all'>关闭全部</a>").appendTo(windowsswitch);
                $("<a href='javascript:void(0)' class='close_others'>关闭其他标签</a>").appendTo(windowsswitch);
            }
            ...
            windowsswitch.css({
                ...
                left: $(btn).offset().left - windowsswitch.width()+24
            });
        ...
        addTabItem: function (options)
        {
          ...
          //修改
            var tabitem = $("<li><a></a><div class='l-tab-links-item-left'></div><div class='l-tab-links-item-right'></div><div class='l-tab-links-item-close'></div><div class='l-tab-links-item-reload'>刷新</div></li>");
